...
@Slf4j
public class InfernoCTFLogger implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        log.info("InfernoCTFLogger initialized with excluded URLs: {}", excludedUrls);
    }

    @Override
    public void destroy() {
        log.info("InfernoCTFLogger destroyed");
    }
}